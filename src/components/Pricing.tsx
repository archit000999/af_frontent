...
const Pricing = () => {
  const features = ["AI scans 50+ job boards in real time to find new roles that match your background, title, and preferences", "We find the right hiring managers using LinkedIn research and verified email data — no guesswork", "AI scan and apply for 20 jobs each day", "10x higher chance of landing interviews by reaching decision-makers before jobs get crowded", "Save 20+ hours every week — focus on prepping for interviews, not hunting for jobs"];
