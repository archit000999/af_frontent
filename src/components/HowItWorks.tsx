...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Within 60 minutes, we email hiring managers with your tailored resume and compelling introduction that cuts through the noise.",
      step: "02",
              ...
              <div key={index} className="relative group">
                <div className="h-full p-8 bg-gradient-to-br from-slate-50 to-white rounded-3xl shadow-xl border border-slate-100 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3">
                  <div className="flex items-center mb-8">
                    ...
                    <span className="text-6xl font-bold bg-gradient-to-r from-slate-200 to-slate-300 bg-clip-text text-transparent">{step.step}</span>
                  </div>
