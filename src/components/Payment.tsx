              ...
              <CardContent className="flex flex-col h-full pt-0">
                <div className="flex-1">
                  <Button
                    ...
                    className={`w-full mb-8 py-4 text-base font-semibold transition-all duration-300 ${
                      plan.popular
                        ? `bg-gradient-to-r ${plan.color} hover:shadow-lg hover:scale-105 text-white`
                        : `border-2 border-blue-500 text-blue-600 bg-white hover:bg-blue-50 hover:border-blue-600`
                    }`}
