              ...
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => setIsExpanded(!isExpanded)}>
                    <span className="text-sm text-gray-700">Personalize how your ApplyFirst answers application questions and send cold emails to Hiring managers on your behalf.</span>
