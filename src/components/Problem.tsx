...
const Problem = () => {
  ...
  return <section id="problem" className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {painPoints.map((point, index) => <div key={index} className="group relative">
        ...
        <div className="text-center">
          <div className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-yellow-100 to-orange-100 border-2 border-yellow-300 text-yellow-800 rounded-2xl shadow-lg">
            ...
            <span className="font-semibold text-lg">Result: You're stuck in a high-effort, low-return process</span>
          </div>
        </div>
      </div>
    </section>;
